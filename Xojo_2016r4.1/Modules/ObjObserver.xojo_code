#tag Module
Protected Module ObjObserver
	#tag Method, Flags = &h1
		Protected Sub Listen(observer As Object, notification As String)
		  // observer
	...
	#tag Method, Flags = &h1
		Protected Sub Unlisten(observer As Object, notification As String)
		  // observer
