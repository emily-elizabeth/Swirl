#tag DesktopWindow
Begin DesktopContainer SwirlPrefsEventsPane
   ...
   Visible         =   True
   Width           =   546
   Begin DesktopCheckBox BounceDockIconForever
      AutoDeactivate  =   True
      Bold            =   False
      ...
      Width           =   254
   End
   Begin DesktopCheckBox DisplayInNotificationCenter
      AutoDeactivate  =   True
      Bold            =   False
      ...
      Width           =   270
   End
   Begin DesktopCheckBox BounceDockIcon
      AutoDeactivate  =   True
      Bold            =   False
   ...
   Begin DesktopCheckBox Speak
      ...
      Width           =   270
   End
   Begin DesktopCheckBox PostInChat
      AutoDeactivate  =   True
      Bold            =   False
      ...
      Width           =   270
   End
   Begin DesktopCheckBox PlayAudio
      AutoDeactivate  =   True
      Bold            =   False
   ...
   Begin DesktopLabel SoundSetLabel
      ...
      Width           =   130
   End
   Begin DesktopSlider SoundSetVolume
      AutoDeactivate  =   True
      Enabled         =   True
      Height          =   20
      HelpTag         =   ""
